 ...
 */
public class BSPackageModel implements Parcelable {

    /**
     * {@link String} constant of the TAG
     */
    private static final String TAG = BSPackageModel.class.getSimpleName();
    ...
    public boolean equals(Object o) {
        ...
        BSPackageModel that = (BSPackageModel) o;
    ...
    /**
     * Method which provide the hash code for the {@link BSPackageModel}
     *
     ...
     */
    protected BSPackageModel(Parcel in) {
     ...
     */
    public static final Creator<BSPackageModel> CREATOR
            = new Creator<BSPackageModel>() {
        @Override
        public BSPackageModel createFromParcel(Parcel source) {
            return new BSPackageModel(source);
        }

        @Override
        public BSPackageModel[] newArray(int size) {
            return new BSPackageModel[size];
        }
    };
    ...
    /**
     * Builder for the {@link BSPackageModel}
     */
    public static final class Builder {

        /**
         * Instance of the {@link BSPackageModel}
         */
        private BSPackageModel model;

        /**
         * Default constructor
         */
        public Builder() {
            model = new BSPackageModel();
        }
        ...
        /**
         * Method which provide to build of the {@link BSPackageModel}
         *
         * @return instance of the {@link BSPackageModel}
         */
        public BSPackageModel build() {
            return model;
        }
    }
}

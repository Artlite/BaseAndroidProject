package com.artlite.bslibrary.container;
...
public final class BSResourceContainer {

    /**
     * Instance
     */
    private static BSResourceContainer instance;
     ...
     */
    private BSResourceContainer() {
        this.ids = new HashMap<>();
        this.classNames = new ArrayList<>();
    }

    /**
     * Method which provide the getting instance of the {@link BSResourceContainer}
     *
     * @return instance of the {@link BSResourceContainer}
     */
    public static BSResourceContainer getInstance() {
        if (instance == null) {
            instance = new BSResourceContainer();
        }
        return instance;
    }

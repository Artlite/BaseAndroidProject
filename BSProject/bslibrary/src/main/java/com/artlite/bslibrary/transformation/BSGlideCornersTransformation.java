 ...
 */
public class BSGlideCornersTransformation implements Transformation<Bitmap> {
    ...
    public BSGlideCornersTransformation(int radius, int margin) {
        this(BSContextManager.getApplicationContext(), radius, margin, CornerType.ALL);
    }

    public BSGlideCornersTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public BSGlideCornersTransformation(BitmapPool pool, int radius, int margin) {
        this(pool, radius, margin, CornerType.ALL);
    }

    public BSGlideCornersTransformation(int radius, int margin,
                                        CornerType cornerType) {
        this(Glide.get(BSContextManager.getApplicationContext()).getBitmapPool(),
